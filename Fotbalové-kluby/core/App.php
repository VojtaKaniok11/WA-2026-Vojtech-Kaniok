...
class App
{
    ...
    protected $method = 'index'; // Výchozí metoda zobrazuje seznam oblíbených týmů
    protected $params = [];
    ...
    public function __construct()
    {
        ...
        // Příklad: Pokud je URL "team/create", hledá se "TeamController.php"
        ...
        // Příklad: Pokud je URL "team/create", hledá se funkce "create()" uvnitř TeamControlleru
        if (isset($url[1])) {
        ...
        // 3. PARAMETRY: Vše, co v URL zbylo, se bere jako parametry (např. ID týmu)
